    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if( response.error == undefined || response.error == '' ) {
                if( frm != '' && response.msg != undefined && response.msg != '' ) {
                    showSuccessMessage( frm, response.msg );
                }
                eval(successFunc + '(response);');
            } else {
                if( frm != '' ) {
                    parseFormErrors( frm, response.error, true );
                }
            }
        }
    });
...
$(function(){
    $(document).click(function (e) {
        let container = $('.js-location-switcher .js-country, .js-location-switcher .js-region, .js-lang-switcher');
